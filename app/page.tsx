                         ...
                         <div style={{ marginTop: '12px', background: '#f8fafc', padding: '10px', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                           ...
                           {Object.keys(progResultsByAthlete).length === 0 ? (
                             ...
                             Object.keys(progResultsByAthlete).map((athId) => {
                               ...
                               return (
                                 <div key={athId} style={{ marginBottom: '8px', background: '#ffffff', padding: '8px', borderRadius: '6px', border: '1px solid #e2e8f0' }}>
                                   <span style={{ fontSize: '12px', color: '#0284c7', fontWeight: 'bold' }}>{athName}:</span>
                                     ...
                                     {Object.keys(resObj).map((blockKey) => {
                                       ...
                                       return (
                                         <div key={blockKey} style={{ marginLeft: '8px', marginBottom: '2px' }}>
                                           • Blocco [{blockKey}]: <strong style={{ color: '#000' }}>Score:</strong> {blockData.score || '-'} | <strong style={{ color: '#000' }}>Note:</strong> {blockData.notes || '-'}
                                         </div>
                                       );
                                     })}
                                   </div>
