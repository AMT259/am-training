...
const SUONO_CORTO = 'data:audio/wav;base64,';
 
const SUONO_MEDIO = 'data:audio/wav;base64,';
...
function preparaAudio() {
  ...
  try {
    ...
    if (!elemMedio) {
      ...
      elemMedio = new Audio(SUONO_MEDIO);
 
      elemMedio.preload = 'auto';
...
function bip(frequenza: number, durata: number) {
  ...
  // Solo il file incorporato: è la strada che funziona su tutti i telefoni.
 
  // Il canale audio del browser lo tengo aperto perché serve a sbloccare la
 
  // riproduzione su iOS, ma non lo uso per suonare: usandoli entrambi si
 
  // sentiva il suono doppio, usando solo quello a volte non si sentiva nulla.
 
  try {
 
    const el = durata >= 0.5 ? elemLungo : durata >= 0.2 ? elemMedio : elemCorto;
    ...
    if (p && p.catch) p.catch(() => { /* bloccato dal telefono */ });
...
export default function TrainingApp() {
  ...
  const [dettaglioEsercizioAperto, setDettaglioEsercizioAperto] = useState<string | null>(null);
  ...
  const pannelloProgrammiRisultati = (athleteId: string, perAtleta?: boolean) => {
    ...
    const suoi = programLibrary
      ...
      .filter((p: any) => {
        ...
        if (p.visibility === 'none') return false;
 
        if (p.visibility === 'all') return true;
 
        return (p.assignedAthleteIds || []).includes(athleteId);
    ...
    return (
      ...
      <div>
        ...
        {suoi.map((prog: any) => {
          ...
          const gg = giorniDallaScadenza(prog.endDate);
 
          const scaduto = gg !== null && gg > 0;
 
          const risultati = coachAllResults[prog.id]?.[athleteId] || {};
          ...
          const giorno = progrGiorno[prog.id] || settObj?.days?.[0]?.dayName;
              ...
              {aperto && !perAtleta && (
                ...
                <div style={{ padding: '12px', borderTop: '1px solid #e2e8f0' }}>
                    ...
                    {settimane.map((w: any) => (
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          setProgrSett((p) => ({ ...p, [prog.id]: w.weekName }));
 
                          if (w.days?.[0]) setProgrGiorno((p) => ({ ...p, [prog.id]: w.days[0].dayName }));
                  ...
                  {blocchi.length === 0 ? (
                    ...
                    blocchi.map((blk: any, bIdx: number) => {
 
                      const dato = risultati[`${wIdx}_${dIdx}_${bIdx}`];
